...
struct PostureScoreView: View {
                ...
                VStack(spacing: 20) {
                    ...
                    VStack {
                        ...
                        Text(String(format: "%.1f", bleViewModel.postureScore)) // ✅ Directly use @Published value
                            ...
                            .background(
                                Circle()
                                    .fill(Color("Score Circle Colour"))
                                    .shadow(color: Color("Score Circle Fade").opacity(0.3), radius: 10)
                            )
                    }
                    .padding(.top, 20)
                    ...
                    .padding()
                    .background(RoundedRectangle(cornerRadius: 10).fill(Color("Chart Back Colour")).shadow(radius: 5))
    ...
    private func scoreColor(_ score: Float) -> Color {
        if score >= 80 { return Color("AccentColor") }
        if score >= 50 { return Color("Medium Colour") }
        return Color("Bad Colour")
    }
}
